...
def run_exp(args: Optional[Dict[str, Any]] = None, callbacks: Optional[List["TrainerCallback"]] = None):
    model_args, data_args, training_args, finetuning_args, generating_args, api_args  = get_train_args(args)
    callbacks = [LogCallback(task_dict=api_args.to_dict())] if callbacks is None else callbacks
